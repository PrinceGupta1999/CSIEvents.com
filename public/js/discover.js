	...
	if(user)
	{
		...
		function setEvents() {
			...
			eventsRef.once('value').then(function(snap) {
				...
				if(pastText == "")
					pastContainer.innerHTML = "<p class='lead text-muted mt-4 mb-4 col-12 text-center'>No Events have Happened</p>";
				if(presentText == "")
					presentContainer.innerHTML = "<p class='lead text-muted mt-4 mb-4 col-12 text-center'>No Events Happening Now</p>";
				if(futureText == "")
					futureContainer.innerHTML = "<p class='lead text-muted mt-4 mb-4 col-12 text-center'>No Events Scheduled to happen in future</p>";
			});
		}
		setEvents();
